...
CREATE TABLE `casos` (
  ...
  `Nombre` text COLLATE utf8_persian_ci,
  ...
  `Solicitud` text COLLATE utf8_persian_ci,
  PRIMARY KEY (`id`)
...
INSERT INTO `casos` VALUES (3,1,'Estudiante de prueba','2020-09-09','13:50:00','Test','Esto es una prueba','Guatemala','Mixco','Test',NULL,'Test',NULL,NULL,NULL,NULL,'6',6,'Asignado',NULL,NULL,NULL,NULL,NULL);
INSERT INTO `casos` VALUES (4,2,'Prueba Estudiante','2020-09-09','18:01:00','Esto es una prueba','Test','Guatemala','Mixco','Test',NULL,'Test2',NULL,NULL,NULL,NULL,NULL,6,'Cerrado','Si',NULL,NULL,NULL,NULL);
INSERT INTO `casos` VALUES (5,5,'Ana Lucía Robles','2020-09-11','20:59:00','Muerte Natural','Prueba de dirección','Petén','Desconocido','Juan Robles',NULL,'Lucía Medina',NULL,NULL,NULL,NULL,NULL,NULL,'Abierto',NULL,NULL,NULL,NULL,NULL);
INSERT INTO `casos` VALUES (6,4,'Patricia Morales','2020-09-11','19:04:00','Muerte natural','Test','Izabal',NULL,'Prueba',NULL,'Prueba',NULL,NULL,NULL,NULL,NULL,9,'Asignado','Si',NULL,NULL,NULL,NULL);
INSERT INTO `casos` VALUES (7,1,'Jefferson Morataya','2020-09-11','15:15:00','Accidente','Dirección de prueba Guatemala','Guatemala','Mixco','Test Padre',NULL,'Test Madre',NULL,NULL,NULL,NULL,'Edificio Tikal Futura',6,'Asignado','Si',NULL,NULL,NULL,NULL);
INSERT INTO `casos` VALUES (8,2,'Luis Medina','2020-09-11','16:44:00','Accidente','Dirección de prueba capital','Guatemala','Guatemala','Test Padre',NULL,'Test Madre',NULL,NULL,NULL,NULL,'Edificio Miraflores',6,'Asignado','Si',NULL,NULL,NULL,NULL);
INSERT INTO `casos` VALUES (9,5,'Ana Lucía Robles','2020-09-19','10:55:00','Asesinato','Ciudad de Guatemala','Guatemala','Guatemala','Test padre',NULL,'Test madre',NULL,NULL,NULL,NULL,'Boulevard Liberación',6,'Asignado','No',NULL,NULL,NULL,NULL);
...
CREATE TABLE `detalles_funeraria` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `paso_uno` text COLLATE utf8_persian_ci,
  `paso_dos` text COLLATE utf8_persian_ci,
  `paso_tres` text COLLATE utf8_persian_ci,
  PRIMARY KEY (`id`)
...
CREATE TABLE `solicitudes_cobro_funerarias` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `caso` int(11) NOT NULL,
  `estatus` text COLLATE utf8_polish_ci,
  `costo` int(11) DEFAULT NULL,
  `descripcion` text COLLATE utf8_polish_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `caso` (`caso`),
...
CREATE TABLE `users` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `funeraria` int(11) DEFAULT NULL,
  `activo` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `users` VALUES (1,'Agente Call Center','agent@callcenter.com','2020-09-09 01:57:39','$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi','GCsd5fAPfKYCmU5BpYJw5aWRVutkl3vvONzFabAgXQQ4bkDMI9xf47dNekH5','2020-09-09 01:57:39','2020-09-09 01:57:39',NULL,NULL,NULL);
