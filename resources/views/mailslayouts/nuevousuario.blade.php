									...
									<div class="col_cont" style="width:100% !important;">
										...
										<div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
																						...
																						<table cellpadding="0" cellspacing="0" width="100%">
																							<tr>
																								<td width="560" class="es-m-p0r" valign="top" align="center">
																									<table cellpadding="0" cellspacing="0" width="100%">
																										<tr>
																											<td align="center" class="es-p20b" style="font-size: 0px">
																	...
																	<tr>
																		<td align="center">
																			<table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600">
																				<tr>
																					<td class="es-p30t es-p10b es-p20r es-p20l" align="left">
																						<table cellpadding="0" cellspacing="0" width="100%">
																							<tr>
																								<td width="560" align="center" valign="top">
																									<table cellpadding="0" cellspacing="0" width="100%">
																										<tr>
																											<td align="justify" class="es-p5t es-p5b es-p30r es-p30l ">
                                                                                                                <nav style="margin: 50px 0px 0px 0px;padding: 3px;background: #A2F0D3!important;color:white!important; text-align: center;">
                                                                                                                    <h1 style="font-size: 28px;line-height: 28px;color: #008080">
                                                                                                                        SISTEMA </br> DE SERVICIOS FUNERARIOS
                                                                                                                    </h1>
                                                                                                                </nav>
																											</td>
																										</tr>
																										...
																										<tr>
																											<td align="center" class="es-p10b">
																												<h1 style="font-size: 28px;line-height: 28px;color: #008080">
																													¡Su cuenta ha sido<br />creada con éxito!</h1>
																											</td>
																										</tr>
																										<tr>
																											<td align="center" class="es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l">
																												<p style="font-size: 17px">Puede ingresar haciendo
																													click en el siguiente link:<br />
																							...
																							<tr>
																								<td width="560" align="center" valign="top">
																									<table cellpadding="0" cellspacing="0" width="100%" style="border-left:2px dashed #cccccc;border-right:2px dashed #cccccc;border-top:2px dashed #cccccc;border-bottom:2px dashed #cccccc;border-radius: 5px;border-collapse: separate">
																										<tr>
																											<td align="center" class="es-p20t es-p20r es-p20l">
																												<h2 style="font-size: 18px">Su contraseña es:</h2>
																											</td>
																										</tr>
																										<tr>
																											<td align="center" class="es-p10t es-p20b es-p20r es-p20l">
																												<h1 style="color: #0000cd;font-size: 30px">
																							...
																							<tr>
																								<td width="560" align="center" valign="top">
																									<table cellpadding="0" cellspacing="0" width="100%" style="border-radius: 5px;border-collapse: separate">
																										<tr>
																											<td align="center" class="es-p10t es-p10b"><span class="es-button-border" style="border-radius: 6px;background: #45818e">
                                                                                                                <a href class="es-button" target="_blank" style="border-left-width: 30px;border-right-width: 30px;border-radius: 6px;background: #45818e;border-color: #45818e">INGRESAR</a>
                                                                                                            </span>
																											</td>
																										</tr>
																									</table>
											...
											<div class="img-container center fixedwidth" align="center" style="padding-right: 0px;padding-left: 0px;">
												<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img class="center fixedwidth" align="center" border="0" src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/698669_681347/editor_images/44841627340517851_2.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 320px; max-width: 100%; display: block;" width="320">
												<!--[if mso]></td></tr></table><![endif]-->
											</div>
											<!--[if (!mso)&(!IE)]><!-->
										</div>
